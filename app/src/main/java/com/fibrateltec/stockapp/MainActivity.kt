...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main) //Inicialar el layout

        //Asiganacion a variables
        btnUsuario = findViewById(R.id.btnusuario)
        btnContraseña = findViewById(R.id.btncontraseña)
        iniciar = findViewById(R.id.iniciar)

        //Valida que al darle al boton de iniciar el usuario y contraseña sean los que se encuntran en la base de datos a partir de la fincion validarCredenciales
    ...
    private fun validarCredenciales(usuario: String, contraseña: String) {
        val url = "https://fibrateltecsas.com/validar_usuario.php"
